...
export const researchItems: ResearchItem[] = [
  {
    ...
    tags: ['NLP & LLMs', 'Large-Scale Data', 'Firm Performance'],
  ...
  },
  {
    ...
    tags: ['Theory Development', 'Competitive Surprise', 'Rivalry'],
  ...
  },
  {
    ...
    venue: 'Target: Academy of Management Journal',
    tags: ['Event Study', 'NLP & LLMs', 'Response Time'],
    categories: ['working'],
    illustration: 'surprise',
    featured: false,
    sortDate: '2026-05-01',
  ...
  },
  {
    ...
    status: 'Data analysis',
    venue: 'Target: Academy of Management Journal',
    tags: ['M&A', 'NLP & LLMs', 'Rival Response'],
    categories: ['working'],
    illustration: 'dynamics',
    featured: false,
    sortDate: '2026-04-01',
  ...
  },
  {
    ...
    tags: ['Positioning Threats', 'Competitive Repertoires', 'Large-Scale Data'],
...
export const teachingStats = [
  { icon: 'users' as const, value: '171', label: 'Students taught' },
